...
window._load_script = function (url, callback, isSubmit) {
  var head = document.querySelector("head"),
    ...
    r = false;
  var submitButton = document.querySelector("#_form_319_submit");
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        ...
        _show_error("319", "Sorry, your submission failed. Please try again.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove("processing");
    }
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById("_form_319_");
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var submitButton = e.target.querySelector("#_form_319_submit");
      submitButton.disabled = true;
      submitButton.classList.add("processing");
      var serialized = _form_serialize(
        document.getElementById("_form_319_")
      ).replace(/%0A/g, "\\n");
      var err = form_to_submit.querySelector("._form_error");
      ...
      const awardGuideInput = document.getElementById("award-guide");
      const downloadFile = awardGuideInput ? awardGuideInput.value : null;
